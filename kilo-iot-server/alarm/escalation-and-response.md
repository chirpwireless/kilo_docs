...
- **Via** — Delivery channels. Email is the baseline channel. SMS and push notifications are available when enabled for the account (see [Delivery Channels](notification-channels.md)).
