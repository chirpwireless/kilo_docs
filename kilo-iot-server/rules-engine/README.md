...
A rule starts with a **Start Event** bound to a specific device and sensor. Each time that sensor reports a new reading, the rule executes. Inside the rule, you can:
