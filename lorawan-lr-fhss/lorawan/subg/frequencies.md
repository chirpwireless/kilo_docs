---
sidebar_position: 6
description: LoRaWAN frequencies by country — reference mapping countries A-Z to their plans (EU868, US915, AS923, IN865).
---

# LoRaWAN Frequencies by Country

Kilo IoT's network is designed to accommodate multiple communication protocols, including the global availability of LoRa 2.4 GHz. Frequency bands can vary significantly depending on the geographical location. To determine the frequency band used in your country, please refer to the information provided below.
